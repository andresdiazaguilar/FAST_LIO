...
ROS    >= Melodic (see [ROS Installation](http://wiki.ros.org/ROS/Installation))
...
You can do so by running the following commands in linux:
```
sudo apt update
sudo apt install -y libpcl-dev libeigen3-dev
```

### 1.3. **livox_ros_driver** & **livox_ros_driver2**
Follow the installation linked in [livox_ros_driver](https://github.com/Livox-SDK/livox_ros_driver), and [livox_ros_driver2](https://github.com/Livox-SDK/livox_ros_driver2). Keep in mind that for the **livox_ros_driver**, you need to install the [Livox-SDK](https://github.com/Livox-SDK/Livox-SDK), and for the **livox_ros_driver2**, you need to install the [Livox-SDK2](https://github.com/Livox-SDK/Livox-SDK2). This is explained in the linked repositories of the **livox_ros_driver** and **livox_ros_driver2**, specifically in their respective `README.md` files.

*Remarks:*
- Since the FAST-LIO must support Livox serials LiDAR firstly, so the **livox_ros_driver** and **livox_ros_driver2** must be installed and **sourced** before run any FAST-LIO luanch file.
